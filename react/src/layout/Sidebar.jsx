...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Config. Lockers', to: '/html/admin/lockers-config.html', icon: 'settings' }
    ]
  },
  {
    id: 'penalidades',
...
const ICONS = {
  ...
  settings: 'M12 3.5a1 1 0 0 1 1 1v.7a6.8 6.8 0 0 1 1.8.8l.5-.5a1 1 0 0 1 1.4 0l1.1 1.1a1 1 0 0 1 0 1.4l-.5.5c.35.56.62 1.16.8 1.8h.7a1 1 0 0 1 1 1v1.6a1 1 0 0 1-1 1h-.7a6.8 6.8 0 0 1-.8 1.8l.5.5a1 1 0 0 1 0 1.4l-1.1 1.1a1 1 0 0 1-1.4 0l-.5-.5a6.8 6.8 0 0 1-1.8.8v.7a1 1 0 0 1-1 1h-1.6a1 1 0 0 1-1-1v-.7a6.8 6.8 0 0 1-1.8-.8l-.5.5a1 1 0 0 1-1.4 0l-1.1-1.1a1 1 0 0 1 0-1.4l.5-.5a6.8 6.8 0 0 1-.8-1.8h-.7a1 1 0 0 1-1-1v-1.6a1 1 0 0 1 1-1h.7a6.8 6.8 0 0 1 .8-1.8l-.5-.5a1 1 0 0 1 0-1.4l1.1-1.1a1 1 0 0 1 1.4 0l.5.5c.56-.35 1.16-.62 1.8-.8v-.7a1 1 0 0 1 1-1H12zm-.8 5.3a3 3 0 1 0 0 6 3 3 0 0 0 0-6z',
